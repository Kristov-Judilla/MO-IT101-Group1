...
| Scenario 1    | 2            | Process payroll with valid inputs  | Employee ID: 10001<br>Start Date: 2024-06-19<br>End Date: 2024-06-30<br>Total Hours: 80<br>Overtime Hours: 0<br>Tardiness Minutes: 15<br>Days Late: 1 | 1. User enters Employee ID.<br>2. User enters start and end dates.<br>3. User enters total hours, overtime hours, tardiness minutes, and days late.<br>4. No holidays in this period. | User sees payroll slip with Net Pay: P40,819.29 (calculated: 80 * 535.71 + allowances - deductions, no holiday pay). |
| Scenario 1    | 3            | Save payroll to CSV                | Output CSV: `C:\Users\Kristov\Documents\COMPROG1\Prog 1 MotorPH\MOTORPHPAYSLIP.csv` | 1. User completes payroll processing for Employee ID 10001.<br>2. Program saves data to CSV.                             | User sees message: "PAYROLL data saved to [path]".                                        |
...
| Scenario 2    | 5            | Process payroll with a holiday     | Employee ID: 10001<br>Start Date: 2024-06-03<br>End Date: 2024-06-18<br>Total Hours: 80<br>Overtime Hours: 0<br>Tardiness Minutes: 15<br>Days Late: 1<br>Worked on 2024-06-12: Yes<br>Hours on 2024-06-12: 8 | 1. User enters Employee ID.<br>2. User enters start and end dates.<br>3. User enters total hours, overtime hours, tardiness minutes, and days late.<br>4. User confirms working 8 hours on Independence Day (2024-06-12). | User sees payroll slip with Net Pay: P47,390.72 (matches the example output with holiday pay). |
| Scenario 2    | 6            | Save payroll to CSV                | Output CSV: `C:\Users\Kristov\Documents\COMPROG1\Prog 1 MotorPH\MOTORPHPAYSLIP.csv` | 1. User completes payroll processing for Employee ID 10001.<br>2. Program saves data to CSV.                             | User sees message: "PAYROLL data saved to [path]".                                        |
| Scenario 3    | 7            | Launch the payroll application     | Path to Employee.csv: `C:\Users\Kristov\Documents\COMPROG1\Prog 1 MotorPH\Employee.csv` | 1. User opens NetBeans.<br>2. User opens the MotorPH project.<br>3. User runs `MOTORPH.java`. | User sees the welcome message: "Welcome to MotorPH Payroll System".                       |
| Scenario 3    | 8            | Process payroll with invalid Employee ID | Employee ID: 99999<br>Start Date: 2024-06-03<br>End Date: 2024-06-18 | 1. User enters an invalid Employee ID.<br>2. User enters start and end dates.                                            | User sees error message: "Employee ID not found".                                         |
| Scenario 3    | 9            | Process payroll with invalid date format | Employee ID: 10001<br>Start Date: 2024/06/03<br>End Date: 2024-06-18 | 1. User enters Employee ID.<br>2. User enters start date in wrong format (YYYY/MM/DD).<br>3. User enters end date.      | User sees error message: "Error: Invalid date format. Please use YYYY-MM-DD."             |
